 ...
 * @author linux
 */
public class ClientChatRoom extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ServerChatRoom
     */
        ...
        try {
            ...
            new Thread(){
                public void run(){
                    while(true){
                        try {
                            String smg=(String) ois.readObject();
                           displayText.append("Client : "+smg+"\n");
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(msgText, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void msgTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_msgTextActionPerformed
        try {
            oos.writeObject(msgText.getText());
            displayText.append("Me : " + msgText.getText()+"\n");
            msgText.setText("");
        } catch (IOException ex) {
            Logger.getLogger(ClientChatRoom.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientChatRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
